 ...
 *
 * It is similar to DAI if DAI had no governence, no fees, and was only backed with WETH and WBTC.
 *
 * Our DSC system should always be "overcollaterazied". At no point, should the value of all collateral <= the $ backed value of all the DSC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATION_BONUS = 10; // This is a 10% bonus for liquidators
     ...
     * @param user The user who has broken the health factor. Their health factor is below MIN_HEALTH_FACTOR
